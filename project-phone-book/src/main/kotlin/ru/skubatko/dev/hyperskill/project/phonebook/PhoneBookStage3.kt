...
class PhoneBookStage3

fun main() {
//    val directory = File("/Users/skubatko/Downloads/directory.txt").readLines()
    val directory = PhoneBookStage3::class.java.getResourceAsStream("/directory.txt").bufferedReader().readLines()
//    val directory = PhoneBookStage3::class.java.getResourceAsStream("/small_directory.txt").bufferedReader().readLines()
//    val find = File("/Users/skubatko/Downloads/find.txt").readLines()
    val find = PhoneBookStage3::class.java.getResourceAsStream("/find.txt").bufferedReader().readLines()
//    val find = PhoneBookStage3::class.java.getResourceAsStream("/small_find.txt").bufferedReader().readLines()
